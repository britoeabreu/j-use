...
!insert (Navio_Model, Integer_Class) into NamespaceImpl_ModelElementImpl

!create Boolean_Class: MMClass
!set Boolean_Class.name = 'Boolean'
!insert (Navio_Model, Boolean_Class) into NamespaceImpl_ModelElementImpl

!create String_Class: MMClass
!set String_Class.name = 'String'
!insert (Navio_Model, String_Class) into NamespaceImpl_ModelElementImpl

!create Date_Class: MMClass
!set Date_Class.name = 'Date'
!insert (Navio_Model, Date_Class) into NamespaceImpl_ModelElementImpl

!create Double_Class: MMClass
!set Double_Class.name = 'Date'
!insert (Navio_Model, Double_Class) into NamespaceImpl_ModelElementImpl
...
!create EnumType_1_Class: MMClass
!set EnumType_1_Class.name = 'EnumType_1'
!insert (Navio_Model, EnumType_1_Class) into NamespaceImpl_ModelElementImpl
...
!insert (CategoriaProfissional_Escreve_Operation, UNKNOWN) into BehavioralFeature_Classifier
...
!insert (Relogio_Acerta_Operation, UNKNOWN) into BehavioralFeature_Classifier
...
!insert (GiroBussula_Calibra_Operation, UNKNOWN) into BehavioralFeature_Classifier
...
!set Embarcacao_andamento_Attribute.visibility = #ERROR
...
!set Embarcacao_rumo_Attribute.visibility = #ERROR
...
!insert (Embarcacao_Afundar_Operation, UNKNOWN) into BehavioralFeature_Classifier
...
!insert (Embarcacao_Embarque_8,Embarcacao_Embarque_8_Embarcacao_AssociationEnd) into Association_AssociationEnd
...
!insert (Embarcacao_Embarque_8,Embarcacao_Embarque_8_Embarque_AssociationEnd ) into Association_AssociationEnd
...
!insert (Embarcacao_Embarque_8,Embarcacao_Embarque_8_Tripulante_AssociationEnd) into Association_AssociationEnd1
